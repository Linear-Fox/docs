...
<details>
    <summary><code>GET</code> <code><b>$API_URL/v1/user/followers/</b></code> <code>(User followers)</code></summary>
    Parameters:

    > | name       |  type              | data type               | description                                                           |
    > |------------|--------------------|-------------------------|-----------------------------------------------------------------------|
    > | userid     |  Required Query    | Number                  | User ID                                                               |

    Responses:
    > | status code | data type     | description                                                                 |
    > |-------------|---------------|-----------------------------------------------------------------------------|
    > | `200`       | `object`      | `{status: '200', followers: 'User followers', following: 'User following'}` |
